...
tonechars = "āáăàēéĕèīíĭìōóŏòūúŭùXXǚǜ"
...
tonecoda = f'[{tonechars}](:?r|ng?)?'
tonepinyin = f'[a-z]*{tonecoda}'
hanzi = r'\u4e00-\u9fff'
...
def processcategory(categoryheader, t):
    ...
    t = re.sub('\n([a-z,]\n)', r'\1', t)
    # merge split pinyin lines (not working)
    ...
    # traditional only -- accept "wadegiles / wadegiles", and delete post-pinyin exclamation marks
